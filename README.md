...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=25&pause=1000&color=36BCF7&center=true&vCenter=true&width=700&lines=BCA+(H)+Student;Full+Stack+Developer;Building+Web+Applications;Learning+Something+New+Every+Day)](https://git.io/typing-svg)
...
* **[iPayUpays](#)**: An official fintech and mobile recharge website focused on a modern, upgraded user interface and secure transactions.
* **[Chit-Chat](#)**: A real-time messaging application featuring secure authentication, group chats, a centered UI layout, and integrated media feeds for social videos.
* **[Interactive Portfolio](#)**: A personal developer portfolio showcasing my projects, skills, and professional summary.
* **[Web Mini-Games](#)**: Built interactive web-based games, including a classic Rock-Paper-Scissors application, to refine logic and DOM manipulation skills.

*(Note: Add your actual repository links where the `#` symbols are above)*
